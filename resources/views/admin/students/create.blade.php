...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="h3 mb-0 text-gray-800">Add New Student</h2>
        ...
        <form action="{{ route('admin.students.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="current_semester" class="form-control" min="1" max="10" value="{{ old('current_semester') }}" required>
                </div>
